...
Express + Supabase Postgres backend for the MithrAI AI Career & Interview Coach platform. AI features (resume ATS analysis, AI mock interview, roadmap generation) are powered by the Claude API.
...
You need:
- **Supabase Postgres Database** (schema provided in `supabase_schema.sql`)
